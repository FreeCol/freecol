...
\item Call "ant dist" in order to build all packages. It might be
...
\item Publish/unpublish "Download Unstable Version" (this page should only
...
\item Update JavaDoc and User Documentation on freecol.org
...
\item Update the links to "Added (0.x.y-branch)" and "Fixed
