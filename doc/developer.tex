...
\item Add a news item to the \href{freecol.org}{FreeCol} website, including a
  download button.
...
\item Post a release message to the FreeCol
  \href{https://sourceforge.net/p/freecol/discussion/141200/}{forum}. Include
  information on savegame compatibility with previous versions, as
  well as information on how to post bug reports regarding the release
  in the bug tracker.
