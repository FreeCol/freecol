...
of Windows and Linux, and on Mac OS X to some extent.
If you are using Linux, using Java 6 is recommended, as its font
rendering is much better. If you are using FreeCol on a different
