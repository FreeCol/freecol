...
\item The \Report{Native Advisor} tells you about your relations with
the various Native nations, and the number of settlements they
possess.
...
Native Settlements display at least two shields: The colour of the
...
Natives already live there, and make use of the land. When your
...
sign on the settlement tile popup and Native Advisor.
...
your colonies as \hyperlink{Native Convert}{Native Converts}. If the
...
Natives. Building a colony too close to other settlements is not a
...
\textbf{Native Players}, some units are only available to
...
The converted natives may join your colonies as \Unit{Native
...
Goods such as sugar, tobacco, cotton and furs. Native Converts can not
...
namely the \Unit{Native Brave} and the \Unit{Native Dragoon}. These are
...
\item Only a unit equipped with horses is able to scout Native
...
\item Only a unit equipped with a bible is commissioned as a
  missionary and able to establish a mission in an Native
...
trains and treasure trains, can not be equipped. The Native Convert is
...
Native Settlements, or through experience. If you put a Free Colonist
...
Native units are more productive than free colonists when working
outside of the colony, and less productive when working inside a
building. Native units can not become free colonists through
education, but all Native units become free colonists as soon as
\hyperlink{Bartolome de las Casas}{Bartolom\'e de las Casas} joins
the \hyperlink{Continental Congress}{Continental Congress}.

However, Native Converts that join your colonies {\em after}
Bartolom\'e de las Casas has been elected to the Continental Congress
will always remain converts and can not be upgraded.

\hyperlink{Scout}{Scouts} can explore the New World and enter Native
Settlements in order to speak with the tribal chiefs. A scout entering
an Native Settlement may become a \hyperlink{Seasoned Scout}{Seasoned
...
\item \hypertarget{Artillery Bonus}{Artillery Bonus}: the defensive
  power of artillery in a colony defending against an Native raid is
  increased by 50\%.
\item \hypertarget{Ambush Penalty}{Ambush Penalty}: the defensive
  power of your units when defending against Natives, and of the units
...
is elected to the Continental Congress, the Natives no longer demand
...
tension levels between you and natives are removed and Native alarm is
...
befriended the Huron Natives and converted many to Christianity. He
...
was a Spanish theologian who spoke out for the conquest of Native
...
subjugated Native settlement will ``convert'' and join a
...
Natives and chastising Spain for their treatment of the Natives. When
Bartolom\'e de las Casas joins the Continental Congress, all existing
Native converts become free
