...
produced by \hyperlink{Ocean}{ocean} and lake tiles. In order to
harvest the bounty of the sea, you will need a \hyperlink{Dock}{Dock},
however.

Breeding new \Goods{Horses} also requires grain, but the horses you
...
\item The \Building{Pasture} surrounding your colony is used to breed
  horses. It can be upgraded to \Building{Stables}, which potentially
