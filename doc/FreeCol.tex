...
includes translations into German, Spanish, Farsi (Persian), Finnish,
French, Hungarian, (Brazilian) Portuguese and Russian, some of which
are not very complete, however. Java will automatically select the
...
selection fails, you can try setting the system property values
\verb$user.language$ and \verb$user.country$ to the appropriate
...
example, you need to specify 
%
\verb$-Duser.language=fr -Duser.country=FR$. 
%
You can also use environment variables to
override the locale, if your operating system supports that. To use
the French translation on a Linux system with a German locale, you
could start FreeCol like this, for example: 
%
\verb$LANG=fr_FR java -Xmx128M -jar FreeCol.jar$.
...
\hypertarget{Building Units and Buildings}{\subsection{Building Units and
Buildings}}
