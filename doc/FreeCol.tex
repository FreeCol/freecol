...
\title{FreeCol Documentation\\User Guide for Version v0.10.0}
\maketitle{}
...
right. You can drag and drop a unit on a tile or a building. The tiles
...
particular game. The sub-directory {\tt
  data/\-base/\-resources/\-fonts} contains several fonts that are
distributed with FreeCol, including the file {\tt ShadowedBlack.ttf},
which contains the black letter font used to display headlines and the
titles of panels. The file {\tt data/\-base/\-resources.properties}
allows you to configure how the assets are used.
...
bounty of the sea, you will need a \hyperlink{Dock}{Dock}, however. In
order to avoid starvation, your colonists store half the food (rounded
down) the colony produces in the warehouse. As a consequence, you can
not use the grain and fish it is made from for any other purpose.
...
breed per turn (provided you have enough food). Remember that horses
do not eat fish, and that your colonists store half the food produced
in the warehouse, regardless of how many horses you would like to be
produced instead.
