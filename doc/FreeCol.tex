...
another players might already have selected your preferred nation.
...
The player adds the current tax rate as a bonus to bells production.
...
The building produces goods even if no units are present.
...
The building enables experts to teach other units.
