...
\item\verb$--user-cache-directory DIRECTORY$ Use the given directory
  ...
  temporary files such as the log file.
...
\item\verb$--debug[[=]MODES]$ Start the game in (non-scoring) debugging
  ...
  `init' (generates a starting colony), `comms' (massive
  client-server communications tracing), and `paths' (more infomation
  is displayed on goto paths).  It defaults to `menus' if null.
