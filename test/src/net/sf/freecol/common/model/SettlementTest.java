...
public class SettlementTest extends FreeColTestCase {
    ...
    public void testCompareNames()
    {
        ...
        ServerUnit soldier = new ServerUnit(game, map.getTile(6, 8), inca, soldierType);

        ServerColony colony = new ServerColony(game, inca, set1, soldier.getTile());
