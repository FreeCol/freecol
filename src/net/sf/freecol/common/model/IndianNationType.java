...
public class IndianNationType extends NationType {
    ...
    /**
     * Describes the plunder generated by a settlement.
     */
    private RandomRange settlementPlunder = new RandomRange();

    /**
     * Describes the plunder generated by the nation's capital.
     */
    private RandomRange capitalPlunder = new RandomRange();
    ...
    /**
     * Get the <code>SettlementPlunder</code> value.
     *
     * @return a <code>RandomRange</code> value
     */
    public final RandomRange getSettlementPlunder() {
        return settlementPlunder;
    }

    /**
     * Set the <code>SettlementPlunder</code> value.
     *
     * @param newSettlementPlunder The new SettlementPlunder value.
     */
    public final void setSettlementPlunder(final RandomRange newSettlementPlunder) {
        this.settlementPlunder = newSettlementPlunder;
    }

    /**
     * Get the <code>CapitalPlunder</code> value.
     *
     * @return a <code>RandomRange</code> value
     */
    public final RandomRange getCapitalPlunder() {
        return capitalPlunder;
    }

    /**
     * Set the <code>CapitalPlunder</code> value.
     *
     * @param newCapitalPlunder The new CapitalPlunder value.
     */
    public final void setCapitalPlunder(final RandomRange newCapitalPlunder) {
        this.capitalPlunder = newCapitalPlunder;
    }
    ...
    */
    ...
    public void readAttributes(XMLStreamReader in) throws XMLStreamException {
        ...
        if (parent != this) {
            ...
            settlementPlunder = parent.settlementPlunder.clone();
            capitalPlunder = parent.capitalPlunder.clone();
        }
    ...
    public void readChild(XMLStreamReader in) throws XMLStreamException {
        ...
        if ("skill".equals(childName)) {
            ...
            in.nextTag(); // close this element
        } else if ("settlement".equals(childName)) {
            settlementPlunder = new RandomRange(in);
        } else if ("capital".equals(childName)) {
            capitalPlunder = new RandomRange(in);
        } else {
            super.readChild(in);
        }
    }
    ...
    protected void writeChildren(XMLStreamWriter out) throws XMLStreamException {
        ...
        settlementPlunder.toXML(out, "settlement");
        capitalPlunder.toXML(out, "capital");
    }
