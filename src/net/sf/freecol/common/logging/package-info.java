 ...
 * <br><br>
 * <code>private static final Logger logger = Logger.getLogger(FreeColGameObject.class.getName());</code>
 * <br><br>
 * to your the class (and replacing "FreeColGameObject" with the name of the class). You may use methods
 * like <code>logger.warning("message");</code> to make log entries.
