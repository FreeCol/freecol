 ...
 */
public class MoveNorthAction extends MapboardAction {

    public static final String id = "moveNorthAction";

    /**
     * Creates a new <code>MoveNorthAction</code>.
     * 
     * @param freeColClient The main controller object for the client.
     */
    MoveNorthAction(FreeColClient freeColClient) {
        super(freeColClient, "moveNorth", null, KeyStroke.getKeyStroke(KeyEvent.VK_NUMPAD8, 0));
    }
