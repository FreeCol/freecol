...
public class ReportIndianAction extends MapboardAction {
    ...
    public static final String ID = ReportIndianAction.class.toString();
    ...
    ReportIndianAction(FreeColClient freeColClient) {
    	super(freeColClient, "menuBar.report.indian", null, KeyEvent.VK_I);        
    }
    ...
    public void actionPerformed(ActionEvent e) {
        freeColClient.getCanvas().showReportPanel(ReportIndianPanel.class.getName());
    }
}
