...
public final class Canvas extends JDesktopPane {
    ...
    public File showSaveDialog(File directory, String defaultName) {
        ...
        File savedFile = showFreeColDialog(new SaveDialog(freeColClient, frame,
                        directory, filters,
                        defaultName),
                null);

        if (!savedFile.getName().contains(extension)) {
            return new File(savedFile.getParent(), savedFile.getName() + "." + extension);
        }
        return savedFile;
    }
