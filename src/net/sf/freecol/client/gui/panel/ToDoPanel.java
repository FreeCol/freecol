...
/**
 * This is the panel that pops up when the user wants to write notes
 * to them self as a to do list.
 */
public final class ToDoPanel extends FreeColPanel {
    ...
    /**
     * Gets the to do note that the user has entered and creates a new line
     *
