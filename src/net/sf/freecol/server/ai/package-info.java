/**
 * The main package of the Artifical Intelligence package tree.
 * <br><br>
 ...
 * <br><br>
 * The server uses a {@code Connection} when communicating with the clients.
 ...
 * <li>Any changes to the model should be done by sending a network message through the "DummyConnection" the computer player is using. The reason for not changing the model directly, is that the server's control code has the responsibility of updating the clients when a change occurs.</li>
 * </ul>
